...
export const equipmentMeterLinkSchema = z.strictObject({
  ...
  meterId: idSchema,
  meterName: z.string().nullable().optional(),
  meterType: z.string().nullable().optional(),
  meterUnit: z.string().nullable().optional(),
  meterEnergySourceName: z.string().nullable().optional(),
  unitId: idSchema.nullable().optional(),
  unitName: z.string().nullable().optional(),
  subUnitId: idSchema.nullable().optional(),
  subUnitName: z.string().nullable().optional(),
...
export const equipmentEnergySourceLinkSchema = z.strictObject({
  ...
  equipmentId: idSchema,
  energySourceId: idSchema,
  energySourceName: z.string().nullable().optional(),
  energySourceType: z.string().nullable().optional(),
  unitId: idSchema.nullable().optional(),
  unitName: z.string().nullable().optional(),
  subUnitId: idSchema.nullable().optional(),
  subUnitName: z.string().nullable().optional(),
