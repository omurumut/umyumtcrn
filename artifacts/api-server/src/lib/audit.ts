...
export const AUDIT_ACTIONS = [
  ...
  "report_archive.retry_requested",
  "report_archive.retry_started",
  "report_archive.retry_completed",
  "report_archive.retry_failed",
  "report_archive.stale_marked_failed",
  ...
  "unit_technical_profile.import_previewed",
  "unit_technical_profile.import_applied",
  "unit_technical_profile.exported",
  ...
  "equipment_field.created",
  "equipment_field.updated",
  "equipment_field.archived",
  "equipment_field.reactivated",
  "equipment.created",
  "equipment.updated",
  "equipment.archived",
